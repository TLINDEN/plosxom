...
>
   ...
   <link href="{$config.whoami}/feed/rss"  rel="alternate" title="{$config.blog_name} (rss feed)"  type="application/rss+xml" />
   ...
   {section name=id loop=$posts}
     <entry>
        ...
        <author>
            ...
            <email>{$config.author_link}</email>
        </author>
        <published>{$posts[id].mtime|date_format}</published>
